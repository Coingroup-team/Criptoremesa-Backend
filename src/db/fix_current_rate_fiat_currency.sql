...
BEGIN
    ...
    SELECT
        ...
        sec_cust.sp_ms_cr_rate_get_valid(
            US.id_resid_country,
            (SELECT cur.id_currency FROM sec_cust.ms_currencies cur WHERE cur.id_country = US.id_resid_country AND cur.type = 'fiat' ORDER BY cur.id_currency ASC LIMIT 1),
            1,
            1,
            US.email_user),
