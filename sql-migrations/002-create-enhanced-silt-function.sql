...
BEGIN
    ...
    IF p_personal_number IS NOT NULL AND v_item_personal_number_id IS NOT NULL THEN
        ...
        WHERE id_user = v_current_full_user.id_user_priv 
        ...
        VALUES (v_current_full_user.id_user_priv, v_item_personal_number_id, p_personal_number, false);
    END IF;
    ...
    IF p_expiry_date IS NOT NULL AND v_item_expiry_date_id IS NOT NULL THEN
        ...
        INSERT INTO sec_cust.lnk_users_extra_data (id_user, id_item, value, edited)
        VALUES (v_current_full_user.id_user_priv, v_item_expiry_date_id, p_expiry_date, false);
    END IF;
    ...
    IF p_document_address IS NOT NULL AND v_item_address_id IS NOT NULL THEN
        ...
        INSERT INTO sec_cust.lnk_users_extra_data (id_user, id_item, value, edited)
        VALUES (v_current_full_user.id_user_priv, v_item_address_id, p_document_address, false);
    END IF;
